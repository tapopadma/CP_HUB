...
/*
* This code needs review. It has bugs :(
*/
...
void SuffixTree::findLCS(string s1, string s2){
	string x = "-";
	string y = "#";
	string ns1 = s1;
	string ns2 = s2;
...
int SuffixTree::findLCS(SuffixNode *node, int i1, int i2)
{
...
SuffixNode * SuffixTree::buildSuffixTree(string s){
	int n = s.length();
	int *a = new int[n];
	for (int i = 0; i < n; i++)
	{
...
void SuffixTree::testSuffixTree(){
